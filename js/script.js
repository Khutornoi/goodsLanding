...
var modalBad = window.document.getElementById('modalBad');
// Get the button that opens the modal
var btnT = window.document.getElementById("purchase-btnT");
var btnB = window.document.getElementById("purchase-btnB");
var btnAt = window.document.getElementById("btnAt");

// Get the <span> element that closes the modal
var span = window.document.getElementsByClassName("close");
...
var request = function request(dataString) {
    ...
    $.post("create-order", { data: dataString }, function (data, status) {
        console.log(data);
...
var dataFormer = function dataFormer(arr) {
    ...
    result = _extends({}, result, { lending_id: window.location.pathname });
    // console.log('result: ');
...
//Validate form start
var fPone = window.document.forms['formPurchase']['number'];
